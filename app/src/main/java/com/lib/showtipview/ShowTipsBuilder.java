...
public class ShowTipsBuilder {
	...
	public ShowTipsBuilder setBuildType(int type){
		this.showtipsView.setShowType(type);
		return this;
	}
	
	public ShowTipsBuilder setTipsType(int type){
		this.showtipsView.setTipsType(type);
		return this;
	}
