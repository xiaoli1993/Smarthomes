package com.nuowei.smarthome.smarthomesdk.http;/**
...
public class HttpManage {
     ...
     * 获取用户订阅的设备列表
     *
     * @param version_id 当前设备列表的版本号，起始版本默认为0。
     */
    public void Getsubscribe(Context context, String version_id, final ResultCallback callback) {
