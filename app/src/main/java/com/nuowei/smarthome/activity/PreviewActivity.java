...
import com.nuowei.smarthome.util.ImageCompressUtils;
import com.nuowei.smarthome.util.SDPathUtils;
import com.nuowei.smarthome.view.imageview.ClipImageView;
...
public class PreviewActivity extends Activity {
	...
	private void initBitmap() {
		try {
			...
			float f = getBitmapDegree(SDPathUtils.getCachePath()+ "nuoweia.jpg");
