 ...
 * 时间：2016/8/17 14:35
 */
public class ChoiceAddDeviceGidwAdapter extends BaseAdapter {
    private Context mContext;
    private ArrayList<ChoiceAddDevice> devices;
    private LayoutInflater inflater;


    public ChoiceAddDeviceGidwAdapter(Activity activity, ArrayList<ChoiceAddDevice> device) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView device_icon = (ImageView) convertView.findViewById(R.id.image_icon);
