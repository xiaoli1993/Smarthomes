 ...
 * @Modify record :
 */
public class MainRecyclerAdapter  extends RecyclerView.Adapter<MainRecyclerAdapter.MyViewHolder> implements MyItemTouchCallback.ItemTouchAdapter {

    private Context context;
    private int src;
    private List<HashMap<String, MainDatas>> results;

    public MainRecyclerAdapter(int src,List<HashMap<String, MainDatas>> results){
