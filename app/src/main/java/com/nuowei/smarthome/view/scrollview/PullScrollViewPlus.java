...
/**
 * @Author : 肖力
 * @Time :  2017/4/20 17:15
 * @Description :
 * @Modify record :
 */

public class PullScrollViewPlus extends ScrollView implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public PullScrollViewPlus(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onFinishInflate() {
        ...
        view = findViewById(R.id.background_img);
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        float y = ev.getY();
        MyApplication.getLogger().d("onTouchEvent", "action=" + action + ",y=" + y);
