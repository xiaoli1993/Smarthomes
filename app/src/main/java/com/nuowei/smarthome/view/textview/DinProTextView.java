...
public class DinProTextView extends TextView {
    ...
    public DinProTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context) {
        ...
        Typeface fonc = Typeface.createFromAsset(assetmanager, "DINPro-Light.otf");
        setTypeface(fonc);
    }
}
