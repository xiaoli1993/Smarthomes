...
import com.libzxing.camera.CameraManager;
import com.libzxing.decode.DecodeThread;
import com.libzxing.utils.BeepManager;
import com.libzxing.utils.CaptureActivityHandler;
import com.libzxing.utils.InactivityTimer;
...
//		requestCameraPermission();
    ...
    public void handleDecode(Result rawResult, Bundle bundle) {
        ...
        if (CaptureType == 0) {
            ...
            Intent resultIntent = new Intent(this, AddContactActivity.class);
...
//		FcPermissions.requestPermissions(this , "我们即将请求相机相关的权限.是否前往请求?" , FcPermissions.REQ_PER_CODE , Manifest.permission.CAMERA);
//	}
//	@Override
...
//		Toast.makeText(this, "已被拒绝获取权限", Toast.LENGTH_LONG).show();
//		FcPermissions.checkDeniedPermissionsNeverAskAgain(this,
//				"我们需要您提供相关权限以使我们能够更好的为您服务.",
//				R.string.set, R.string.cancel, null, perms);
//	}
