...
//			mContext.sendBroadcast(go_da_control);
            ...
            case R.id.scene_mode_control:
                ...
                break;
            case R.id.smart_device_control:
                // 智能设备
