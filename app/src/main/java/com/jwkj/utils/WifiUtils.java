...
public class WifiUtils {
	...
	public static WifiUtils getInstance() {
		if (wifiutils == null) {
			wifiutils = new WifiUtils(MyApplication.app);
		}
		if (wifiutils.wifiManager == null) {
			wifiutils.wifiManager = (WifiManager) MyApplication.app
					.getSystemService(Context.WIFI_SERVICE);
		}
		return wifiutils;
	}
					...
					if (null != mHandler) {
						...
						try {
							bundle.putSerializable("address",
									InetAddress.getByName(Utils.getAPDeviceIp(context)));
...
//			config.preSharedKey = "\"" + Password + "\"";
	...
	public String getConnectWifiName(){
		  WifiManager wifiManager = (WifiManager)MyApplication.app.getSystemService(Context.WIFI_SERVICE);
		  if(wifiManager==null){
			  return "";
		  }
