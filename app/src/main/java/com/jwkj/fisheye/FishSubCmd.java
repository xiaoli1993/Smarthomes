...
public class FishSubCmd {
    ...
    public static final byte MESG_SUBTYPE_CONTROL_LED=60;
    public static final byte MESG_SUBTYPE_CONTROL_LED_RET=61;
    public static final byte MESG_SUBTYPE_GET_LED_STATU=62;
    public static final byte MESG_SUBTYPE_GET_LED_STATU_RET=63;
    public static final byte MESG_SUBTYPE_SET_SESOR_PRESET_POS=64;
}
