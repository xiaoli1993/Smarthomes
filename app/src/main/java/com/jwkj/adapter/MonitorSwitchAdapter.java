...
public class MonitorSwitchAdapter extends RecyclerView.Adapter<MonitorSwitchAdapter.ViewHolder> {
    ...
    private static float w= MyApplication.SCREENWIGHT/4;
    private int h;
    ...
    @Override
    public MonitorSwitchAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(MonitorSwitchAdapter.ViewHolder holder, final int position) {
