...
public class SensorRecycleAdapter extends RecyclerView.Adapter<SensorRecycleAdapter.ViewHolder> {
    ...
    @Override
    public SensorRecycleAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final SensorRecycleAdapter.ViewHolder holder, final int position) {
