...
//		ImageLoader.getInstance().loadImage(this.mPath, new SimpleImageLoadingListener(){
//			 public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
//				 setPictrueBitmap(loadedImage);
//			 };
//		 });	
	
	}
	public void setPictrueBitmap(Bitmap loadedImage){
		this.setImageBitmap(mBitmap);
	}
