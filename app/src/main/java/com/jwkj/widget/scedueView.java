...
public class scedueView extends View {
    ...
    private String[] days = new String[]{MyApplication.app.getString(R.string.time_mon), MyApplication.app.getString(R.string.time_tue)
    		, MyApplication.app.getString(R.string.time_wen), MyApplication.app.getString(R.string.time_thur), MyApplication.app.getString(R.string.time_fri)
    		, MyApplication.app.getString(R.string.time_sat), MyApplication.app.getString(R.string.time_sun)};
