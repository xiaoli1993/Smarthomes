...
public class EditorAndDeletePop extends PopupWindow {
    ...
    public interface onDeleteAndEditorListner{
        void EditorClick(SensorRecycleAdapter2.ViewHolder holder,Sensor sensor,int position);
        void DeletClick(SensorRecycleAdapter2.ViewHolder holder,Sensor sensor,int position);
    }

    public SensorRecycleAdapter2.ViewHolder getHolder() {
        return holder;
    }

    public void setHolder(SensorRecycleAdapter2.ViewHolder holder) {
        this.holder = holder;
    }
}
