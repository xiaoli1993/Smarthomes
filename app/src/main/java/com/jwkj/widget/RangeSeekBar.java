...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    private final float LINE_HEIGHT_IN_DP = 2.5f;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextOffset = this.mTextSize + Utils.dip2px(context,
    ...
    public void setSuffix(int R){
    	setSuffix(getResources().getString(R));
    }
    ...
    protected synchronized void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int height = thumbImage.getHeight() + Utils.dip2px(getContext(), HEIGHT_IN_DP);
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        int bitMinH=thumMin.getHeight();
    	int bitMinW=thumMin.getWidth();
    	int bitMaxH=thumMax.getHeight();
    	int bitMaxW=thumMax.getWidth();
    	float minMaxLabelSize = Math.max(bitMinW, bitMaxW);
        if(SeekBarType==0){
        	String minLabel = "";
            String maxLabel = "";
           // float minMaxLabelSize = Math.max(paint.measureText(minLabel), paint.measureText(maxLabel));真实有文字时打开
        	...
        	int offsetBitmap=Utils.dip2px(getContext(), DEFAULT_TEXT_SIZE_IN_DP+DEFAULT_TEXT_DISTANCE_TO_BUTTON_IN_DP+DEFAULT_TEXT_DISTANCE_TO_TOP_IN_DP);
        	canvas.drawBitmap(thumMin, INITIAL_PADDING, (getHeight()-offsetBitmap-bitMinH)/2+offsetBitmap, paint);
        	canvas.drawBitmap(thumMax, getWidth()-minMaxLabelSize-INITIAL_PADDING, (getHeight()-bitMaxH-offsetBitmap)/2+offsetBitmap, paint);
        	padding = INITIAL_PADDING + minMaxLabelSize + thumbHalfWidth;
        }
        ...
        if (!selectedValuesAreDefault) {
            ...
            int offset = Utils.dip2px(getContext(), TEXT_LATERAL_PADDING_IN_DP);

            String minText = String.valueOf(getSelectedMinValue())+suffix;
            String maxText = String.valueOf(getSelectedMaxValue())+suffix;
    ...
    public interface OnRangeSeekBarChangeListener<T> {
        ...
        public void onRangeSeekBarValuesSelected(RangeSeekBar<?> bar, T minValue, T maxValue,int type);
    }
