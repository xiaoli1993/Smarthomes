...
public class SelectDialogAdapter extends RecyclerView.Adapter<SelectDialogAdapter.ViewHolder> {
    ...
    @Override
    public SelectDialogAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final SelectDialogAdapter.ViewHolder holder, final int position) {
