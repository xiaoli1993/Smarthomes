...
public abstract class BasePlayBackActivity extends BaseCoreActivity implements IVideoPTS{
	...
	public int fastPlay(int value){return MediaPlayer.iRecFilePlayingControl(FASTPLAY,value,"fast".getBytes());}
	public int fastPlayCancel(int value){return MediaPlayer.iRecFilePlayingControl(FASTPLAY_CANCEL,value,"fast".getBytes());}
    public int SetNoneState(){return MediaPlayer.iRecFilePlayingControl(NONE,0,"none".getBytes());}
