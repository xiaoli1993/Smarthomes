...
public class Constants {
	...
	public static class MsgSection{
		...
		//绗簩娆℃坊鍔�
			    ...
			    public static int MESG_ID_FISHEYE_SET_SENSOR_PREPOINT=145000;
			    public static int MESG_GET_VIDEO_COLOR = 146000;
		        public static int MESG_SET_VIDEO_COLOR = 147000;
				public static int MSG_ID_SETTING_NPC_SETTINGS_MOTION_SENS = 148000;
	}
