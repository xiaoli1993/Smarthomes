...
public class DefenceSelectTimeActivity extends BaseActivity implements
	...
	public void onClick(View v) {
		// TODO Auto-generated method stub
		int i = v.getId();
		if (i == R.id.dst_back_btn) {
			this.finish();

		} else if (i == R.id.dst_save_btn) {
			toSave();
	...
	OnWheelChangedListener wheelChangedListener = new OnWheelChangedListener() {
		...
		public void onChanged(WheelView wheel, int oldValue, int newValue) {
			// TODO Auto-generated method stub
			int i = wheel.getId();
			if (i == R.id.dst_hour_from) {
				defenceWorkGroup.setbBeginHour((byte) newValue);

			} else if (i == R.id.dst_minute_from) {
				defenceWorkGroup.setbBeginMin((byte) newValue);

			} else if (i == R.id.dst_hour_to) {
				defenceWorkGroup.setbEndHour((byte
						) newValue);

			} else if (i == R.id.dst_minute_to) {
