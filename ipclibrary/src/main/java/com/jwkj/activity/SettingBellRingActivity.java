...
public class SettingBellRingActivity extends BaseActivity implements
	...
	public void initCompent() {
		...
		map.put("bellName", "default");
		map.put("bellId", "0");
		bells.add(map);
		ArrayList<HashMap<String, String>> mbells = SystemDataManager
		...
		list_sys_bell.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				HashMap<String, String> data = (HashMap<String, String>) adapter
						.getItem(arg2);
				if (data.get("bellName").equals("default")) {
					int id = Integer.parseInt(data.get("bellId"));
					checkedId = id;
					selectPos = arg2;
					adapter.setCheckedId(0);
	...
	public void onClick(View view) {
		...
		} else if (i1 == R.id.set_sd_bell_btn) {
	...
	public void playMusic(int bellId) {
		...
		try {
			...
			if (bellId != 0) {
				...
				// player.setDataSource(afd.getFileDescriptor());//不设置起点和长度会播放完ASSERTS目录下文件
