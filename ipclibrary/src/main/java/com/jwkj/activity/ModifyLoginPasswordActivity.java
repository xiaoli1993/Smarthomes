	...
	class ModifyLoginPasswordTask extends AsyncTask {
		...
		protected void onPostExecute(Object object) {
			...
			case NetManager.MODIFY_LOGIN_PWD_SUCCESS:
				...
				resultBack.putExtra("sessionId",result.sessionId);
				resultBack.putExtra("pwd",newPwd);
				setResult(AccountInfoActivity.ModifySuccess, resultBack);
				finish();
				break;
			...
			case NetManager.SYSTEM_DOWN:
				...
				T.showLong(mContext, R.string.system_down);
				break;
			default:
				if (dialog != null) {
					dialog.dismiss();
