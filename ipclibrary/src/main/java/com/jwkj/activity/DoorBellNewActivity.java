...
public class DoorBellNewActivity extends Activity implements OnClickListener,
	...
	private void getExtralIntent(Intent intent) {
		...
		isSupportDelete=getIntent().getBooleanExtra("isSupportDelete", false);
	...
	public void initComponent() {
		...
		if (null != contact) {
			alarmIdName.setText(contact.contactName+"lele");
		} else {
	...
	void setAlarmType(int stringId) {
		...
		alarm_type_text.setText(R.string.guest_coming);
	...
	BroadcastReceiver br = new BroadcastReceiver() {
		...
		public void onReceive(Context arg0, Intent intent) {
			if (intent.getAction().equals(
				...
				finish();
			}else if(intent.getAction().equals(Constants.P2P.DELETE_BINDALARM_ID)){
