...
public class SettingSystemActivity extends BaseActivity implements
	...
	public void onClick(View view) {
		...
		} else if (i == R.id.c_vibrate_btn) {
			changeCVibrate();

		} else if (i == R.id.set_commingRing) {
		...
		} else if (i == R.id.c_mute_btn) {
			changeCMute();

		} else if (i == R.id.a_vibrate_btn) {
			changeAVibrate();

		} else if (i == R.id.notify_icon_btn) {
			changeIsShowNotifyIcon();

		} else if (i == R.id.auto_start_btn) {
			changeIsAutoStartIcon();

		} else if (i == R.id.set_allarmRing) {
		...
		} else if (i == R.id.a_mute_btn) {
			changeAMute();

		} else if (i == R.id.alarm_set_btn) {
