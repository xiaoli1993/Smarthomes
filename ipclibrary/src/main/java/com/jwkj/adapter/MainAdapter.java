...
public class MainAdapter extends BaseAdapter {
	...
	class ViewHolder {
		...
		public void setModeView(FishEyeModeView modeView) {
...
//	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (null == view||size==1) {
		    ...
		    FishEyeModeView modeView=(FishEyeModeView)view.findViewById(R.id.fmv_main);
		    holder.setModeView(modeView);
			view.setTag(holder);
		} else {
		...
		if(contact.isConnectApWifi==true){
			...
			holder.getHead().updateImage(contact.contactId, false,contact.contactType);
...
//				如果子设备类型支持情景
				if(contact.isSmartHomeContatct()){
					showMode(holder, contact);
				}else{
//					holder.getR_mode().setVisibility(View.GONE);
					holder.getModeView().setVisibility(FishEyeModeView.GONE);
					holder.getR_online_state().setVisibility(View.VISIBLE);
				}
				...
				holder.getProgress_defence().setVisibility(View.GONE);
                //不在线不显示模式			
				holder.getModeView().setVisibility(View.GONE);
			}
			// 获得布防状态之后判断弱密码
			if (contact.onLineState == Constants.DeviceState.ONLINE
...
//			});
			...
			holder.getIv_playback().setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
				    ...
				    if(contact.onLineState==Constants.DeviceState.ONLINE){
				    	...
				    	T.showLong(context, R.string.offline_state);
				    }
				}
			});
			...
			holder.getModeView().setOnClickListener(new OnClickListener() {
...
//			}
//			holder4.getImg_set().setOnComfirmClickListener(new OnClickListener() {
//				
//				@Override
//				public void onClick(View arg0) {
//					// TODO Auto-generated method stub
...
//		}
		     ...
		     holder3.getIv_editor().setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						...
						try {
							saveContact.ipadressAddress=InetAddress.getByName(Utils.getAPDeviceIp(context));
...
//		 	holder3.getIv_set().setOnComfirmClickListener(new OnClickListener() {
//				
//				@Override
//				public void onClick(View arg0) {
//					// TODO Auto-generated method stub
...
//				}
//			});
//			holder3.getIv_playback().setOnComfirmClickListener(new OnClickListener() {
//				
//				@Override
//				public void onClick(View arg0) {
//					// TODO Auto-generated method stub
...
//				}
//			});
//			holder3.getIv_defence_state().setOnComfirmClickListener(new OnClickListener() {
//				
//				@Override
//				public void onClick(View arg0) {
//					// TODO Auto-generated method stub
...
//		if(contact.FishMode==P2PValue.FishMode.FISHMODE_HOME){
//			holder.getBt_mode().setBackgroundResource(R.drawable.bg_mode_home);
//			holder.getTv_mode().setText(context.getResources().getText(R.string.mode_home));
//		}else if(contact.FishMode==P2PValue.FishMode.FISHMODE_OUT){
//			holder.getBt_mode().setBackgroundResource(R.drawable.bg_mode_out);
//			holder.getTv_mode().setText(context.getResources().getText(R.string.mode_out));
//		}else if(contact.FishMode==P2PValue.FishMode.FISHMODE_SLEEP){
//			holder.getBt_mode().setBackgroundResource(R.drawable.bg_mode_sleep);
//			holder.getTv_mode().setText(context.getResources().getText(R.string.mode_sleep));
//		}else{
//			holder.getBt_mode().setBackgroundResource(R.drawable.bg_mode_home);
//			holder.getTv_mode().setText(context.getResources().getText(R.string.mode_home));
//		}
		holder.getModeView().setTextDeviceName(contact.contactName);
		holder.getModeView().setModeStatde(contact.FishMode);
		holder.getProgress_defence().setVisibility(View.GONE);
		holder.getIv_defence_state().setVisibility(RelativeLayout.INVISIBLE);
		holder.getR_online_state().setVisibility(View.GONE);
//		holder.getR_mode().setVisibility(View.VISIBLE);
		holder.getModeView().setVisibility(View.VISIBLE);
	}
