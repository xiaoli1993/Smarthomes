...
public class SharedPreferencesManager {
   ...
   //	存商城的Url
	...
	public void putHelpUrl(Context context,String url){
		SharedPreferences sf = context.getSharedPreferences(SP_FILE_GWELL, context.MODE_PRIVATE);
		Editor editor = sf.edit();
	...
	public String getHelpUrl(Context context){
		SharedPreferences sf = context.getSharedPreferences(SP_FILE_GWELL, context.MODE_PRIVATE); 
		return sf.getString(HELP_URL, "");
	}
	public void putHelpIndexUrl(Context context,int index){
		SharedPreferences sf = context.getSharedPreferences(SP_FILE_GWELL, context.MODE_PRIVATE);
		Editor editor = sf.edit();
		editor.putInt(HELP_INDEX, index);
		editor.commit();
	}
	public int getHelpIndexUrl(Context context){
		SharedPreferences sf = context.getSharedPreferences(SP_FILE_GWELL, context.MODE_PRIVATE); 
		return sf.getInt(HELP_INDEX, 0);
	}
	public void putShowGuide(Context context,String sValue,boolean bool) {
		SharedPreferences sf = context.getSharedPreferences(SP_FILE_GWELL,
				context.MODE_PRIVATE);
		Editor editor = sf.edit();
		editor.putBoolean(sValue, bool);
		editor.commit();
	}

	
	public boolean getShowGuide(Context context,String sValue) {
		SharedPreferences sf = context.getSharedPreferences(SP_FILE_GWELL,
				context.MODE_PRIVATE);
		return sf.getBoolean(sValue, false);
	}
	public void putWifiPwd(Context context,String sValue,String pwd) {
		SharedPreferences sf = context.getSharedPreferences(SP_FILE_GWELL,
				context.MODE_PRIVATE);
		Editor editor = sf.edit();
		editor.putString(WIFI_PWD+sValue,pwd);
		editor.commit();
	}
	public String getWifiPwd(Context context,String sValue) {
		SharedPreferences sf = context.getSharedPreferences(SP_FILE_GWELL,
				context.MODE_PRIVATE);
		return sf.getString(WIFI_PWD+sValue,"");
	}
}
