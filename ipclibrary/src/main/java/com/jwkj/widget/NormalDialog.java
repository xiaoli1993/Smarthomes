...
public class NormalDialog {
	...
	public void showModifyTimeAndModeDialog(final WorkScheduleGroup grop) {
		...
		txHome.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
		...
		txOut.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
		...
		txSleep.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
	...
	public void showModeSelectDialog(final int contactPsoition) {
		...
		Drawable drawableh = MyApp.app.getResources().getDrawable(
		...
		Drawable drawableo = MyApp.app.getResources().getDrawable(
		...
		Drawable drawables = MyApp.app.getResources().getDrawable(
		...
		txOffice.setOnClickListener(new OnClickListener() {
		...
		dialog.setContentView(view);
		LayoutParams layout = (LayoutParams) view.getLayoutParams();
		layout.width = (int) (MyApp.SCREENWIGHT*0.7);
		layout.height=(int) (MyApp.SCREENHIGHT*0.5);
		view.setLayoutParams(layout);
		dialog.setCanceledOnTouchOutside(true);
		dialog.setCancelable(true);
		Window window = dialog.getWindow();
	...
	public void showSelectTime(final int type,final DefenceWorkGroup group,final int position) {
		...
		OnWheelChangedListener wheelListener = new OnWheelChangedListener() {
			...
			public void onChanged(WheelView wheel, int oldValue, int newValue) {
				if (timeSelectListner != null) {
					int i = wheel.getId();
					if (i == R.id.dg_hour_from) {
						timeSelectListner
								.onTimeChange(time, newValue, 0, group);

					} else if (i == R.id.dg_minute_from) {
						timeSelectListner
								.onTimeChange(time, newValue, 1, group);

					} else if (i == R.id.dg_hour_to) {
						timeSelectListner
								.onTimeChange(time, newValue, 2, group);

					} else if (i == R.id.dg_minute_to) {
						timeSelectListner
		...
		params.width = (int) (MyApp.SCREENWIGHT * 0.88);
		params.height = (int) (MyApp.SCREENHIGHT * 0.45);
