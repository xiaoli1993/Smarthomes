...
public class ExpandeLinearLayout extends RelativeLayout implements View.OnClickListener {
    ...
    public ExpandeLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        ...
        switch (Integer.parseInt(v.getTag().toString())) {
            ...
            case 1://删除
                if (listner != null && mScedueView != null) {
                    listner.onDeleteClick((WorkScheduleGroup)mScedueView.getWorkGroup());
                }
                break;
            case 2://修改时间组
                ...
                if (!isAnimal && (ExpandeState == EXPANDE) && listner != null) {
                    Log.e("dxsTest", "isAnimal-->" + isAnimal + "ExpandeState-->" + ExpandeState);
                    listner.onTimeClick((WorkScheduleGroup)mScedueView.getWorkGroup());
                }
                break;
        }
    }
    ...
    public interface ExpandeLinearLayoutListner {
        ...
        void onTimeClick(WorkScheduleGroup group);

        void onDeleteClick(WorkScheduleGroup group);
    }

    private ExpandeLinearLayoutListner listner;

    public void setOnExpandeLinearLayoutListner(ExpandeLinearLayoutListner listner) {
