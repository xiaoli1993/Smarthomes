...
public class AppConfig {
	...
	public static class Relese {
		...
		public static final String PREPOINTPATH = Environment.getExternalStorageDirectory().getPath()+ File.separator+ "prepoint" + File.separator + NpcCommon.mThreeNum;
        ...
        public static final boolean isShowEhome=false;//是否使用eHome的测试功能
	}
