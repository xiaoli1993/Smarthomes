...
//				reject();
	...
	public void onClick(View v) {
		...
		} else if (i == R.id.header_icon_play) {
			Log.e("dxspppwwwddd", "密码--" + APContacts.contactPassword);
