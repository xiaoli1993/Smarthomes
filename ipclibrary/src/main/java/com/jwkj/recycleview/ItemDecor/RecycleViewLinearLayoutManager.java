...
public class RecycleViewLinearLayoutManager extends LinearLayoutManager {

	public RecycleViewLinearLayoutManager(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	public RecycleViewLinearLayoutManager(Context context, int orientation,
